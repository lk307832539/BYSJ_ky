	...
	<div class="bodywrapper">
		...
		<div class="centercontent tables">
			<div class="pageheader notab">
				<h1 class="pagetitle">成为租客</h1>
				<span class="pagedesc">查看和修改租客信息</span>
			...
			<div id="basicform" class="subcontent">
				...
				<form class="stdform" action="member/beTenantAct.do" method="post" enctype="multipart/form-data">
					<p>
					...
					<p>
						<label>请输入驾驶证号</label> <span class="field"><input name="drivinglicence" type="text" class="smallinput"></span>
					</p>
					<p>
						<label>请输入驾驶证类型</label> <span class="field"><input name="drivingtype" type="text" class="smallinput"></span>
					</p>
					<p>
