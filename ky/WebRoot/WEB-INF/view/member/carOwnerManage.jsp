	...
	<div class="bodywrapper">
		...
		<div class="centercontent tables">
			...
			<div class="pageheader notab">
				<h1 class="pagetitle">车主管理</h1>
				<span class="pagedesc">这里可以查看车主信息</span>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick">
					...
					<tbody>
						<c:forEach items="${carOwnerList }" var="carOwner">
							<tr>
								<td class="con0">${carOwner.user.userName }</td>
								<td class="con1">${carOwner.user.email }</td>
								<td class="con0">${carOwner.user.registerTime }</td>
								<td class="center">${carOwner.realName }</td>
								<td class="center">${carOwner.phone }</td>
								<td class="center">${carOwner.isChecked }</td>
								<td class="center"><a href="member/carOwnerDetail.do?ownerid=${carOwner.ownerId }" class="toggle">查看详情</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
